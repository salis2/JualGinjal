package com.example.jualginjal.Adapter;
...
import com.example.jualginjal.Fragment.HomeFragment;
import com.example.jualginjal.MainActivity;
import com.example.jualginjal.Model.Sepatu;
import com.example.jualginjal.R;
import com.example.jualginjal.UpdateSepatu;
...
public class HomeAdaptor extends RecyclerView.Adapter<HomeAdaptor.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final HomeAdaptor.ViewHolder holder, final int position) {
        ...
        String ukuranSepatu = daftarSepatus.get(position).getSize().toString();
        String notelpSepatu = daftarSepatus.get(position).getNoTeleponPenjual();

        holder.emailPenjual.setText(emailPenjualSepatu);
        holder.titeSepatu.setText("Nama : " + namaSepatu);
        holder.bodySepatu.setText("Merek : " + brandSepatu);
        holder.sizes.setText("No.Telp : " + notelpSepatu);
        holder.notelp.setText("Ukuran : " + ukuranSepatu);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView emailPenjual, titeSepatu, bodySepatu, notelp, sizes;
        CardView itemSepatu;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            sizes = (TextView) itemView.findViewById(R.id.sepatu_size);
            notelp = (TextView) itemView.findViewById(R.id.sepatu_notelp);
